...
const CPU_INT16U  GPIO_PIN[LEDn]  = {GPIO_Pin_12,
                                     GPIO_Pin_11,
                                     GPIO_Pin_0,
                                     GPIO_Pin_1};

const CPU_INT32U  GPIO_CLK[LEDn]  = {RCC_AHB1Periph_GPIOA,
...
static void  BSP_LED_Init()
{
    ...
    GPIO_Init(GPIO_PORT[led_num], &GPIO_InitStructure);
		...
		GPIO_ResetBits(GPIO_PORT[2], GPIO_PIN[2]);
		GPIO_SetBits(GPIO_PORT[3], GPIO_PIN[3]);
}
